...
% get indices and glossaries working
% shamelessly stolen from
% https://tex.stackexchange.com/questions/145944/make-symbol-index-with-description
...
\newglossary[LieGrps]{LieGroups}{liegrp-gls}{liegrp-glo}{Lie Groups}

\makeglossaries

% Define a command to define Lie Groups
% Syntax: \newliegrp[options]{label}{lie group symbol}

\newcommand*{\newliegrp}[3][]{%
  \newglossaryentry{#2}{type=LieGroups,%
    name={$#3$},text={#3},description={},#1}%
}

% Define lie groups

\newliegrp{GLn}{\mathsf{GL}(n)}
